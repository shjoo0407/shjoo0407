...
데이터 분석, 머신러닝 & 딥러닝을 공부하고 있는 개발자입니다.
<br>
...
|상훈명|대회명|수여 기관|일시|
|:--:|:--:|:--:|:--:|
|대상|교내 빅데이터 분석 공모전|명지대학교|23년 09월|
|이사장상||국립공원공단|22년 12월|
...
|기간|프로젝트명|프로젝트 설명|기술|
|:--:|:--:|:--:|:--:|
|23.06~23.08|정치 성향 분류기|국회의원 속기록 학습을 바탕으로 신문기사의 정치 성향 파악하기|`Pytorch`,`NLP`,`transformer`|
|23.04~23.06|똑똑한 식단관리 서비스 'Cal로리'|음식 이미지 처리 딥러닝 모델을 활용한 식단관리 서비스|`Pytorch`,`data:Image`,`Torchserve`,`React.js`,`MySQL`,`Django`|
|23.04~23.06|사내 프로그램 개발|'프람트 솔루션' 사내 프로그램 개발|`html`,`css`,`js`,`node.js`,`MySQL`|
|22.10~22.11|따릉이 고장 예측|서울열린데이터광장 데이터를 활용해 고장 확률이 높은 자전거 추출|`Python`,`Hadoop`,`SparkSQL`,`Task:Regression`|
|22.08~22.09|대출 여부 예측|'핀다' 어플의 로그 데이터를 통한 대출신청 예측 분석 및 사용자 군집화|`Python`,`autoML`,`optuna`,`RandomForest`,`LGBM`|
...
[![trophy](https://github-profile-trophy.vercel.app/?username=shjoo0407&row=1&theme=nord)](https://github.com/ryo-ma/github-profile-trophy)
